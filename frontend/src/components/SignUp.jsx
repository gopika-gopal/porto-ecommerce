...
const SignUp = () => {
    ...
    const registerUser = (event) => {
        ...
        // HTTP verbs/Methods - post, get, put, delete - CRUD
        var apiurl = "http://localhost:3000/sign-up";
                    ...
                    <header className="header">
                        <div className="header-middle">
                            <div className="container">
                                ...
                                <div className="header-right w-lg-max" hidden>
                                    ...
                                    <Link to='/' className="header-icon login-link"><i className="icon-user-2" /></Link>
                                ...
                                <div className="col-md-6">
                                    ...
                                    <form onSubmit={registerUser}>
                                        ...
                                        <div className="form-footer">
                                            ...
                                            <span style={{ marginLeft: '3rem', marginRight: '0.6rem', color: 'black' }}  >Already have an account?</span> <Link className="forget-pass" to="/">Login</Link>
                                        </div>{/* End .form-footer */}
                                    </form>
                                </div>{/* End .col-md-6 */}
                            </div>{/* End .row */}

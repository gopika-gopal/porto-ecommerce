...
const ForgotPassword =() =>{
    ...
    // start of Forgot Password page logic
    ...
    console.log(user);
    axios.post('http://localhost:3000/forgot-password', user)
      .then(response => {
    ...
    // end of Forgot Password page logic
       ...
       <div className='row'>
        ...
        <form onSubmit={forgotPassword}>
          <div className="form-group required-field">
            ...
            <input type="email" className="form-control" id="reset-email" placeholder='Email Address' required 
